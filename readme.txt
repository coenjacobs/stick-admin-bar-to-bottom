...
= 0.2.2 =
* Tiny bug fix, caused by my previous fix

= 0.2.1 =
* Fixed some more minor issues to display correctly in most themes

= 0.2 =
* Added some more CSS to clear and add required white space
